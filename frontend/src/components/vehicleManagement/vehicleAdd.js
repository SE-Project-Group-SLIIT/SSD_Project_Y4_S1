...
function AddVehicle() {
	...
	const YearsValidation = () => {
		...
		if (YearsRent == 0) {
			YearsErr.InValidYears =
				" Number of years should be More than 0"; // error msg
			YearsValid = false;
			Swal.fire({
				icon: "error",
			...
			YearsErr.InValidYears =
				" Number of years should be less than 10 !"; // error msg
			YearsValid = false;
			Swal.fire({
				icon: "error",
				title: "Oops...Numbers of Years Invalid",
	...
	const validateRegNo = (event) => {
		...
		if (VehRegex1.test(RegNo)) {
			...
			setRegIsValid(false);
			setRegMessage(
				"Please enter a valid Vehicle Registation Number !",
			);
		}
	};
		...
		<div className="page-component-body ">
			...
			<div class="container input-main-form-emp pt-3">
				...
				<ul class="nav nav-tabs" id="myTab" role="tablist">
					...
					<div
						class="tab-content tab-content-V  col-12"
						id="myTabContent">
						<div
								...
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
										<form
											...
											<div className="row">
												<div class="form-group col-md-6">
													...
													<select
														...
														<option value="Full Insurance">
															Full Insurance
														</option>
														<option value="Third-party Insurance">
															Third-party
															Insurance
														</option>
													</select>
											...
											<div class="row">
												<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
													<h3 className="topic-V text-left mt-2 mb-4">
														Payment & Agreement
														Details
													</h3>
												</div>
