  ...
  useEffect(() => {
	...
	const deleteEmployee = async (id) => {
		try {
			...
			if (response.success === true) {
				...
				Swal.fire({
					title: "Success!",
					text: "Employee Profile Inactive Successfully",
					icon: "success",
	...
	const restoreEmployee = async (id) => {
		try {
			...
			// You can handle the response as needed
			if (response.success === true) {
				// Employee was made active successfully
				Swal.fire({
					title: "Success!",
					text: "Employee Profile Ative Successfully",
					icon: "success",
					showConfirmButton: false,
					timer: 2000,
				}).then(() => {
								...
								return (
									<tr>
										...
										<td class="text-center">
											...
											{/* Check if employee.isActive is true */}
											{employee.isActive ? (
												<button
													onClick={() =>
														openModalEmpDelete(
          ...
          />
				...
				<Modal
					...
					<Modal.Header closeButton>
						<Modal.Title>Confirm Inactivation</Modal.Title>
					</Modal.Header>
					<Modal.Body>
						<p>
							Would you like to inactive this employee
							account ?
						</p>
					</Modal.Body>
					<Modal.Footer>
